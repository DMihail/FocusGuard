...
| ----------------------------- | ------------------------------------------------------------------------ |
| Product name                  | Keept                                                                    |
| npm / JS version              | `1.0.10` (`package.json`)                                                |
| Android store version         | `1.0.10` (`versionName` in `android/app/build.gradle`)                   |
| Android build number          | `15` (`versionCode` in `android/app/build.gradle`)                       |

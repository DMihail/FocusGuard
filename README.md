...
| ----------------------------- | ------------------------------------------------------------------------ |
| Product name                  | Keept                                                                    |
| npm / JS version              | `1.1.2` (`package.json`)                                                 |
| Android store version         | `1.1.3` (`versionName` in `android/app/build.gradle`)                    |
| Android build number          | `17` (`versionCode` in `android/app/build.gradle`)                       |

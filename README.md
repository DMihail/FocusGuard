...
| ----------------------------- | ------------------------------------------------------------------------ |
| Product name                  | Keept                                                                    |
| npm / JS version              | `1.1.1` (`package.json`)                                                 |
| Android store version         | `1.1.1` (`versionName` in `android/app/build.gradle`)                    |
| Android build number          | `16` (`versionCode` in `android/app/build.gradle`)                       |

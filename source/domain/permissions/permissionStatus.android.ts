...
import { checkForManifestMonitorPermissions } from '@/specs/keeptTurboModuleApi.android';
 ...
 *
 * Usage Access flicker/revoke handling lives only in native `UsageAccess` /
 * `UsageAccessGrantStore` — JS must not write the shared MMKV latch.
 */

  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '• Служба специальных возможностей (необязательно) — чтобы быстрее определять переключение приложений и надёжнее срабатывала блокировка. Служба отслеживает только смену окон; не читает текст на экране, не записывает нажатия клавиш и не делает скриншоты.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '• Читает текст или содержимое UI через необязательную службу специальных возможностей (только события смены окна).',
    ...
    },
    {
      ...
      paragraphs: [
        'Вы можете менять отслеживаемые приложения, настройки уведомлений и специальных возможностей в приложении и отзывать разрешения Android в системных настройках.',

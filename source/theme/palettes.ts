...
/** Material 3 light — same purple brand, inverted surfaces. */
export const lightColors: ColorPalette = {
  ...
  progressTrack: 'rgba(121, 116, 126, 0.28)',
  successMuted: 'rgba(56, 106, 32, 0.08)',
  successBorder: 'rgba(56, 106, 32, 0.28)',
  successIconBg: 'rgba(56, 106, 32, 0.12)',
  card: '#FFFFFF',
  cardBorder: 'rgba(121, 116, 126, 0.22)',
  accentMuted: 'rgba(103, 80, 164, 0.1)',
  accentIconBg: 'rgba(103, 80, 164, 0.12)',
  privacyBackground: 'rgba(247, 242, 250, 0.95)',
  privacyBorder: 'rgba(121, 116, 126, 0.16)',
  buttonDisabled: 'rgba(28, 27, 31, 0.06)',
  appIconBackground: 'rgba(231, 224, 236, 0.9)',
  switchTrackOff: 'rgba(28, 27, 31, 0.14)',
  privacyHighlightBorder: 'rgba(103, 80, 164, 0.22)',
  privacyHighlightBg: 'rgba(103, 80, 164, 0.06)',
  privacyHighlightIconBg: 'rgba(103, 80, 164, 0.14)',
